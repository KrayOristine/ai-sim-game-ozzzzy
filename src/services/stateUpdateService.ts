...
export const updateEncyclopediaEntriesFromNarration = async (
  gameState: GameState,
  lastNarration: string,
...
export const updateCharacterStateFromNarration = async (
  gameState: GameState,
  lastNarration: string,
...
export const normalizeCategoriesWithAI = async (
...
export const deduplicateEntitiesInCategoryWithAI = async (
  entities: { name: string; id: string }[],
): Promise<{ idToDelete: string; idToKeep: string }[]> => {
