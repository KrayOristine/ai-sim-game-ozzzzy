  ...
  const updates = [
    {
      version: "1.9.0",
      notes:[
        "**Thêm model**: Thêm các model 3.0 Flash và 3.1 Flash Lite",
        "**Tăng giới hạn**: Tăng giới hạn token có thể sửa từ 8000 thành 65k tương đương với giới hạn token tối đa trong 1 request của tất cả model",
        "**Thêm tùy chỉnh**: Thêm tùy chỉnh cấp độ thinking, chỉ có tác dụng đối với các model thuộc thế hệ 3.0 trở đi",
        "**Ưu hóa tốc độ tải web**: Ưu hóa tăng ~41% tốc độ khởi chạy web trên pc và ~20% trên mobile"
      ]
    },
    {
      version: "1.8.0 (Siêu Cập Nhật: Gemini 3.0 & Tối Ưu Hóa Cốt Lõi)",
      notes: [
