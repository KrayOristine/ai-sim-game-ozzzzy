...
import { CORE_ENTITY_TYPES, ENTITY_TYPE_OPTIONS } from '#/const';
    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
            ...
            <ConfirmationModal
                ...
                message={confirmState.type === 'delete_category'
                ...
                confirmLabel={confirmState.type === 'delete_category' ? "Xóa Danh Mục" : "Bắt Đầu Chuẩn Hóa"}
