      ...
      >
        ...
        <div className="grow overflow-y-auto p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <p>
                  ...
                  {stripTags(characterPersonality || "")}
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-pink-300 border-b border-pink-500/30 pb-1 mb-2">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-1">
                              <button
                                ...
                                className="cursor-pointer p-1 text-slate-400 hover:text-white transition"
            ...
            <div>
              <h3 className="text-lg font-semibold text-yellow-300 border-b border-yellow-500/30 pb-1 mb-2">
                Túi Đồ
              </h3>
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex items-center gap-2 ml-2">
                          ...
                          <button
                            onClick={() => onDeleteEntity({ name: item.name })}
                            className="cursor-pointer p-1 text-slate-400 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity"
                          >
                            <Icon name="trash" className="icon-sm" />
                          </button>
                        </div>
