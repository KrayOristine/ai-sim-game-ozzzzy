...
export const HARM_CATEGORIES: { [key in HarmCategory]: string } = {
  ...
  [HarmCategory.HARM_CATEGORY_CIVIC_INTEGRITY]: "Tính toàn vẹn dân sự",
  [HarmCategory.HARM_CATEGORY_IMAGE_HARASSMENT]: "Hình ảnh quấy rối",
  [HarmCategory.HARM_CATEGORY_IMAGE_HATE]: "Hình ảnh hận thù",
  [HarmCategory.HARM_CATEGORY_IMAGE_DANGEROUS_CONTENT]: "Hình ảnh nội dung nguy hiểm",
  [HarmCategory.HARM_CATEGORY_IMAGE_SEXUALLY_EXPLICIT]: "Hình ảnh khiêu dâm",
  [HarmCategory.HARM_CATEGORY_JAILBREAK]: "Jailbreak",
};
...
export const HARM_BLOCK_THRESHOLDS: { [key in HarmBlockThreshold]: string } = {
  ...
  [HarmBlockThreshold.BLOCK_LOW_AND_ABOVE]:
    "Chặn cả mức thấp (nghiêm ngặt nhất)",
