...
- **Cấu trúc câu & Tâm lý:** Dùng câu văn tập trung vào hành động. Miêu tả chi tiết cơ chế vật lý (ma sát, âm thanh, dịch thể) và cảm xúc bản năng (ham muốn, thỏa mãn, đau đớn).`,
    ...
    violenceLevel: {
      "Cực đoan":
        "Miêu tả các cảnh bạo lực một cách cực đoan, không ngần ngại đi sâu vào các chi tiết đồ họa, tàn bạo và máu me ghê rợn.",
    },
    storyTone: {
      "Dâm dục":
        "Nhấn mạnh các yếu tố khêu gợi, ham muốn và căng thẳng tình ái trong suốt câu chuyện, không chỉ trong các cảnh cụ thể.",
    },
  },
...
- **Cấu trúc câu & Tâm lý:** Dùng câu văn dài, có tính biền ngẫu, tả cảnh ngụ tình. Tâm lý nhân vật gắn liền với việc tu luyện (VD: thu thập âm nguyên, đột phá cảnh giới thông qua song tu). Tập trung miêu tả sự hòa quyện của 'âm-dương', 'linh khí', hoặc 'nội tức'.`,
    ...
    violenceLevel: {
      "Cực đoan":
        "Miêu tả các cảnh bạo lực một cách cực đoan, không ngần ngại đi sâu vào các chi tiết đồ họa, tàn bạo. Sử dụng các thuật ngữ Hán Việt như: huyết nhục văng tung tóe, gân cốt đứt lìa, nguyên thần vỡ nát, hồn phi phách tán.",
    },
    storyTone: {
      "Dâm dục":
        "Nhấn mạnh vào các yếu tố song tu, mị thuật, các loại công pháp hoặc tâm pháp liên quan đến dục vọng, sự chiếm hữu và mối quan hệ đạo lữ trong thế giới tu chân.",
    },
  },
...
- **Cấu trúc câu & Tâm lý:** Dùng câu ngắn, gãy gọn, nhịp độ nhanh. Tập trung vào tâm lý thực dụng, ham muốn tức thời, hoặc sự phức tạp trong các mối quan hệ hiện đại. Mô tả không gian bằng các danh từ đặc trưng (ánh đèn neon, tiếng còi xe, mùi thuốc lá, ga trải giường trắng).`,
    ...
    violenceLevel: {
      "Cực đoan":
        "Miêu tả các cảnh bạo lực một cách trần trụi và thực tế như trong phim hành động. Không né tránh các chi tiết về máu, vết thương do súng đạn, cháy nổ, hoặc các trận đấu tay đôi tàn bạo.",
    },
    storyTone: {
      "Dâm dục":
        "Nhấn mạnh vào sự căng thẳng giới tính trong môi trường hiện đại, các mối quan hệ công sở, tình một đêm, sự khám phá tình dục, và các yếu tố liên quan đến ham muốn trong xã hội ngày nay.",
    },
  },
...
- **Cấu trúc câu & Tâm lý:** Dùng câu văn trực tiếp, tập trung vào sức mạnh và sự thống trị. Tâm lý nhân vật thường mãnh liệt, bản năng, ít nội tâm phức tạp hơn so với phương Đông. Tập trung vào sự tương tác vật lý mạnh mẽ, sự thống trị hoặc phục tùng.`,
    ...
    violenceLevel: {
      "Cực đoan":
        "Miêu tả các cảnh chiến trận hoặc đấu tay đôi một cách tàn bạo và đẫm máu. Không né tránh các chi tiết về vũ khí lạnh chém vào da thịt, xương gãy, nội tạng, và sự đau đớn của nhân vật.",
    },
    storyTone: {
      "Dâm dục":
        "Nhấn mạnh vào sự đam mê, ham muốn carnal, các mối tình vụng trộm trong cung điện, sự quyến rũ của các sinh vật huyền bí (succubus, incubus), và các yếu-tố-tục-tĩu trong bối cảnh tửu quán hoặc lễ hội.",
    },
  },
};
