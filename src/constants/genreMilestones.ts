...
export const KIEM_HIEP_MILESTONES: CharacterMilestone[] = [
  ...
  },
  {
    ...
    value: "Bình thường",
    description:
      "Tư chất bẩm sinh để luyện võ, ảnh hưởng đến tốc độ lĩnh ngộ và tu luyện nội công. Cấp bậc thường được mô tả là: Bình thường, Luyện võ kỳ tài, Tuyệt thế kỳ tài, Vạn năm có một.",
    category: "Thân Thể",
  },
];
...
export const DO_THI_DI_NANG_MILESTONES: CharacterMilestone[] = [
  ...
  },
  {
    ...
    value: "Bình thường",
    description:
      "Mức độ cường hóa của cơ thể để thích ứng với dị năng. Cấp bậc thường tương ứng với Cấp Bậc Dị Năng hoặc được đo lường riêng biệt (VD: Cường hóa cấp 1, cấp 2...).",
    category: "Thân Thể",
  },
];
...
export const GENERIC_DEFAULT_MILESTONES: CharacterMilestone[] = [
  {
    ...
    value: "Chưa xếp hạng",
    description:
      "Cấp bậc, thứ hạng hoặc đẳng cấp sức mạnh của nhân vật trong hệ thống của thế giới.",
    category: "Tu Luyện",
  },
  {
    name: "Thể Chất",
...
export const resolveMilestonesByGenre = (
  ...
  if (
    lowerGenre.includes("kiếm hiệp") ||
    lowerGenre.includes("võ lâm") ||
    lowerGenre.includes("giang hồ")
  ) {
  ...
  if (
    lowerGenre.includes("đô thị") &&
    (lowerGenre.includes("dị năng") || lowerGenre.includes("hệ thống"))
  ) {
